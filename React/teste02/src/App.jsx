...
function App() {
  ...
  const handleCadastroReceita = (event) => {
    ...
    const novaReceita = { nome, ingredientes };
  ...
  const adicionarIngrediente = () => {
    if (ingrediente && quantidade && unidade) {
      const novoIngrediente = { nome: ingrediente, quantidade: parseFloat(quantidade), unidade };
  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleCadastroReceita}>
        ...
        <input type="text" id="ingrediente" value={ingrediente} onChange={(e) => setIngrediente(e.target.value)}  />
        
        <label htmlFor="quantidade">Quantidade:</label>
        <input type="number" id="quantidade" value={quantidade} onChange={(e) => setQuantidade(e.target.value)}  />
        
        <label htmlFor="unidade">Unidade:</label>
        <input type="text" id="unidade" value={unidade} onChange={(e) => setUnidade(e.target.value)}  />
